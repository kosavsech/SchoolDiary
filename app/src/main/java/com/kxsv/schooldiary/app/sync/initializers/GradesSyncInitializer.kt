	...
	fun initialize(context: Context) {
		WorkManager.getInstance(context).apply {
			...
			enqueueUniquePeriodicWork(
				GradesSyncWorkName,
				GradesSyncWorkPolicy,
				GradeSyncWorker.startUpSyncWork(),
			)
		}
	}
}
...
internal const val GradesSyncWorkName = "RecentGradesSyncWorker"

internal val GradesSyncWorkPolicy = ExistingPeriodicWorkPolicy.CANCEL_AND_REENQUEUE
