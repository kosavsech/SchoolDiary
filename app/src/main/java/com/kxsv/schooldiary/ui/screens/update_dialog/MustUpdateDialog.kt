...
private const val TAG = "MustUpdateDialog"
...
fun MustUpdateDialog(
	...
	var dialogProperties by remember { mutableStateOf(NonDismissibleDialog.properties) }
	...
	UpdateDialogContent(
		...
		title = R.string.new_critical_update_found,
