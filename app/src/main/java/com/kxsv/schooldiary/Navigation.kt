...
fun Navigation(){
    ...
    NavHost(navController = navController, startDestination = Screen.HomeScreen.route){
        ...
        composable(route = Screen.ScheduleScreen.route){
            DaySchedulePreview(navController = navController, drawerState = drawerState, scope = scope)
        }
        ...
        composable(route = Screen.AttendanceScreen.route){
            AttendanceScreen(navController = navController, drawerState = drawerState, scope = scope)
        }
        ...
        composable(route = Screen.RecordingsScreen.route){
            RecordingsScreen(navController = navController, drawerState = drawerState, scope = scope)
        }
