...
class SegmentedCoordinatesComputerTest {
	...
	fun `segment coordinates for 1 segment`() {
		...
		// WHEN
		val firstSegmentCoordinates =
			helper.segmentCoordinates(0, segmentCount, width, height, spacing, angle)
	...
	fun `segment coordinates for 2 segments without spacing`() {
		...
		val firstSegmentCoordinates =
			helper.segmentCoordinates(0, segmentCount, width, height, spacing, angle)
		val secondSegmentCoordinates =
			helper.segmentCoordinates(1, segmentCount, width, height, spacing, angle)
	...
	fun `segment coordinates for 3 segments without spacing`() {
		...
		val secondSegmentCoordinates =
			helper.segmentCoordinates(1, segmentCount, width, height, spacing, angle)
		val thirdSegmentCoordinates =
			helper.segmentCoordinates(2, segmentCount, width, height, spacing, angle)
	...
	fun `progress coordinates for 3 segments with spacing and positive angle`() {
		...
		// WHEN
		val noProgressionSegmentCoordinates =
			helper.progressCoordinates(0f, segmentCount, width, height, spacing, angle)
		val oneProgressionSegmentCoordinates =
			helper.progressCoordinates(1f, segmentCount, width, height, spacing, angle)
		val twoProgressionSegmentCoordinates =
			helper.progressCoordinates(2f, segmentCount, width, height, spacing, angle)
		val fullProgressionSegmentCoordinates = helper.progressCoordinates(
	...
	private fun SegmentCoordinates.shouldBeNear(
        topLeft: Float,
        bottomLeft: Float,
        topRight: Float,
        bottomRight: Float,
