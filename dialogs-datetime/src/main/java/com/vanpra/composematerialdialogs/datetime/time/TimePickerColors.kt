...
interface TimePickerColors {
	...
	@Composable
	fun periodTextColor(active: Boolean): State<Color>
}
...
internal class DefaultTimePickerColors(
	...
	private val onInactivePeriodBackground: Color,
	private val activePeriodBackground: Color,
	private val onActivePeriodBackground: Color,
	...
	override fun periodBackgroundColor(active: Boolean): State<Color> {
		return rememberUpdatedState(if (active) activePeriodBackground else inactivePeriodBackground)
	}
	
	@Composable
	override fun periodTextColor(active: Boolean): State<Color> {
		return rememberUpdatedState(if (active) onActivePeriodBackground else onInactivePeriodBackground)
	}
}
