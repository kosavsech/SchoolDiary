...
interface DatePickerColors {
	...
	@Composable
	fun dateOutlineColor(isToday: Boolean): State<Color>
	 ...
	 */
	@Composable
	fun dateTextColor(active: Boolean, isToday: Boolean): State<Color>
}
...
internal class DefaultDatePickerColors(
	...
	@Composable
	override fun dateOutlineColor(isToday: Boolean): State<Color> {
		return rememberUpdatedState(
			if (isToday) {
	...
	@Composable
	override fun dateTextColor(active: Boolean, isToday: Boolean): State<Color> {
		return rememberUpdatedState(
			if (active) {
				dateActiveTextColor
			} else if (isToday) {
